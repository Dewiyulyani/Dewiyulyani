...
if($row['status'] == 'pesan'){
    ...
    // $htmlData .='<a href="/reservasi/out/'.$row['id_reservasi'].'" class="btn btn-cekout btn-sm mr-1 disabled">Cek Out</a>';
}elseif ($row['status'] == 'cek in') {
    // $htmlData .='<a href="/reservasi/in/'.$row['id_reservasi'].'" class="btn btn-info btn-sm mr-1 disabled">Cek In</a>';
